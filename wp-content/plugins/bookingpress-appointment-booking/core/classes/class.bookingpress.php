    ...
    class BookingPress Extends BookingPress_Core
    {
                ...
                if (isset($links['deactivate']) ) {
                    ...
                    $deactivation_link   = str_replace(
                        ...
                        '<div class="bpalite-deactivate-form-wrapper">
	                         <span class="bpalite-deactivate-form '.$bpa_is_rtl_enabled.'" id="bpa-deactivate-form-' . esc_attr('BookingPressLite') . '"></span>
        ...
        function bookingpress_deactivate_feedback_popup()
        {
          ...
          <?php  // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Reason: output is properly escaped or hardcoded ?>
                            bpalite_formContainer.html( '<?php echo $html; ?>');
        ...
        function upgrade_data()
        {
            ...
            if (version_compare($bookingpress_old_version, '1.0.50', '<') ) {
        ...
        function bookingpress_admin_footer_func()
        {
            ...
            if (strpos($requested_module, 'bookingpress_') !== false || $requested_module == 'bookingpress' ) {
                ...
                <?php
                if (( isset($_REQUEST['page']) && $_REQUEST['page'] == 'bookingpress' ) || $requested_module == 'appointments' || $requested_module == 'calendar' || $requested_module == 'services' || $requested_module == 'staff_members' || $requested_module == 'settings' || $requested_module == 'timesheet' ) {
                    ?>
                ...
                <?php do_action('bookingpress_' . $requested_module . '_dynamic_computed_methods'); ?>
                        ...
                        methods: {
                            ...
                            bookingpress_appointment_get_disable_dates( reset_timeslot_field = true ){
                                ...
                                .then( function(response){
                                    if( response.data.variant == "success" ){
                                        ...
                                        /** change current date */
                                        /* var tmp_date = response.data.selected_date;
                                        tmp_date = tmp_date.replace(/-/g, "/");
                                        tmp_date = new Date(tmp_date);
                                        vm.appointment_formdata.appointment_booked_date = tmp_date; */
                            ...
                            editAppointmentData(index,row, calendar = false) {
                                const vm2 = this
                            ...
                            editEvent(event, e){
                                if( "undefined" != event.is_past_time && true == event.is_past_time ){
                                    return false;
                                }
                                const vm = this;
                                let row = {
                                ...
                                this.editAppointmentData( -1, row, true );
                            },
        ...
        public static function install()
        {
            ...
            if (empty($_version) || $_version == '' ) {
                ...
                global $tbl_bookingpress_categories, $tbl_bookingpress_services, $tbl_bookingpress_servicesmeta, $tbl_bookingpress_customers, $tbl_bookingpress_settings, $tbl_bookingpress_default_workhours, $tbl_bookingpress_default_daysoff, $tbl_bookingpress_notifications, $tbl_bookingpress_appointment_bookings, $tbl_bookingpress_payment_logs, $tbl_bookingpress_entries, $tbl_bookingpress_form_fields, $tbl_bookingpress_customize_settings,$tbl_bookingpress_debug_payment_log, $tbl_bookingpress_customers_meta, $tbl_bookingpress_other_debug_logs;
        ...
        {
            global $wp, $wpdb, $tbl_bookingpress_categories, $tbl_bookingpress_services, $tbl_bookingpress_servicesmeta, $tbl_bookingpress_customers, $tbl_bookingpress_customers_meta, $tbl_bookingpress_settings, $tbl_bookingpress_default_workhours, $tbl_bookingpress_default_daysoff, $tbl_bookingpress_notifications,$tbl_bookingpress_appointment_bookings, $tbl_bookingpress_payment_logs, $tbl_bookingpress_entries, $tbl_bookingpress_form_fields, $tbl_bookingpress_customize_settings, $tbl_bookingpress_debug_payment_log,$bookingpress_capabilities_global,$BookingPress,$tbl_bookingpress_other_debug_logs;
            /**
             * Delete Meta Values
             */
        ...
        function bookingpress_menu()
        {
            ...
            add_submenu_page($bookingpress_slugs->bookingpress, __('Upgrade to Pro', 'bookingpress-appointment-booking'), __('Upgrade to Pro', 'bookingpress-appointment-booking'), 'bookingpress', $bookingpress_slugs->bookingpress."&upgrade_action=upgrade_to_pro", array( $this, 'route' ));
        ...
        function set_css()
        {
            ...
            echo "<style type='text/css'>#toplevel_page_bookingpress .wp-menu-image img, #toplevel_page_bookingpress_wizard .wp-menu-image img, #toplevel_page_bookingpress_lite_wizard .wp-menu-image img{ padding: 0 !important; opacity: 1 !important; }</style>";
            ...
            if (isset($_REQUEST['page']) && in_array(sanitize_text_field($_REQUEST['page']), (array) $bookingpress_slugs) ) {
                ...
                if (! empty($_REQUEST['page']) && ( sanitize_text_field($_REQUEST['page']) == 'bookingpress_customers' || sanitize_text_field($_REQUEST['page']) == 'bookingpress_customize' || sanitize_text_field($_REQUEST['page']) == 'bookingpress_settings' || $_REQUEST['page'] == 'bookingpress_myprofile' || $_REQUEST['page'] == "bookingpress_appointments" || $_REQUEST['page'] == "bookingpress_calendar" ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
        ...
        function set_front_css( $force_enqueue = 0 )
        {
            ...
            if ($this->bookingpress_is_front_page() || ( $bookingress_load_js_css_all_pages == 'true' ) || ( $force_enqueue == 1 ) || ($bookingpress_after_approved_payment_page_id == $bookingpress_current_page_id) || ($bookingpress_cancelled_appointment_page_id == $bookingpress_current_page_id) || ($bookingpress_after_canceled_payment_page_id == $bookingpress_current_page_id) ) {
                wp_enqueue_style('bookingpress_element_css');
                wp_enqueue_style('bookingpress_fonts_css');
        ...
        function bookingpress_load_booking_form_custom_css() {
            ...
            if (file_exists(BOOKINGPRESS_UPLOAD_DIR . '/bookingpress_front_custom_' . $bookingpress_customize_css_key . '.css') ) {
                ...
                if (! empty($bookingform_title_font_family) && ($bookingform_title_font_family != 'Poppins') ) {
        ...
        function bookingpress_load_mybooking_custom_css() {
            ...
            if (file_exists(BOOKINGPRESS_UPLOAD_DIR . '/bookingpress_front_mybookings_custom_' . $bookingpress_customize_css_key . '.css') ) {
                ...
                $bookingform_title_font_family = $this->bookingpress_get_customize_settings('title_font_family', 'booking_form');
                if (! empty($bookingform_title_font_family) ) {
        ...
        function bookingpress_load_mybookings_custom_js(){
            wp_register_script('bookingpress_v-calendar_js', BOOKINGPRESS_URL . '/js/bookingpress_v-calendar.js', array(), BOOKINGPRESS_VERSION);
         ...
         * @return void
         */
        public function bookingpress_get_customize_settings( $setting_names, $setting_type ){
		 ...
		 * @return void
		 */
		public function bookingpress_is_appointment_booked($service_id, $booking_date, $booking_start_time, $booking_end_time,$appointment_id = 0){
			...
			if($bookingpress_shared_service_timeslot == 'true'){
                if(!empty($appointment_id)) {
                    $is_appointment_booked = $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(bookingpress_appointment_booking_id) as total FROM {$tbl_bookingpress_appointment_bookings} WHERE bookingpress_appointment_date = %s  AND bookingpress_appointment_booking_id != %d AND ((bookingpress_appointment_time >= %s AND bookingpress_appointment_time < %s) OR (bookingpress_appointment_time < %s AND bookingpress_appointment_end_time > %s ) )", $booking_date,$appointment_id, $booking_start_time, $booking_end_time, $booking_end_time, $booking_start_time ) ); //phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared --Reason: $tbl_bookingpress_appointment_bookings is table name
                } else {
                    $is_appointment_booked = $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(bookingpress_appointment_booking_id) as total FROM {$tbl_bookingpress_appointment_bookings} WHERE bookingpress_appointment_date = %s AND ((bookingpress_appointment_time >= %s AND bookingpress_appointment_time < %s) OR (bookingpress_appointment_time < %s AND bookingpress_appointment_end_time > %s ) )", $booking_date, $booking_start_time, $booking_end_time, $booking_end_time, $booking_start_time ) ); //phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared --Reason: $tbl_bookingpress_appointment_bookings is table name
                }
			}else{
                $where_clause = '';
                ...
                if(!empty($appointment_id)) {
                    ...
                    $is_appointment_booked = $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(bookingpress_appointment_booking_id) as total FROM {$tbl_bookingpress_appointment_bookings} WHERE bookingpress_appointment_date = %s AND bookingpress_service_id = %d AND ((bookingpress_appointment_time >= %s AND bookingpress_appointment_time < %s) OR (bookingpress_appointment_time < %s AND bookingpress_appointment_end_time > %s ) ) $where_clause", $booking_date, $service_id, $booking_start_time, $booking_end_time, $booking_end_time, $booking_start_time ) ); //phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared --Reason: $tbl_bookingpress_appointment_bookings is table name
                }
			}
        ...
        public function bookingpress_is_appointment_cancelled_or_rejected($service_id, $booking_date, $booking_start_time, $booking_end_time){
			...
			if($bookingpress_shared_service_timeslot == 'true'){                
                // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- Reason: $tbl_bookingpress_payment_logs is table name defined globally. False Positive alarm
                $check_timeslot_canceled_data = $wpdb->get_row($wpdb->prepare("SELECT `bookingpress_appointment_booking_ref` FROM {$tbl_bookingpress_payment_logs} WHERE bookingpress_appointment_date LIKE %s AND ((bookingpress_appointment_start_time >= %s AND bookingpress_appointment_start_time < %s) OR (bookingpress_appointment_start_time < %s AND bookingpress_appointment_end_time > %s ) ) ORDER BY bookingpress_appointment_booking_ref DESC", "%{$booking_date}%", $booking_start_time, $booking_end_time, $booking_end_time, $booking_start_time ),ARRAY_A); 
            } else {                
                // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- Reason: $tbl_bookingpress_payment_logs is table name defined globally. False Positive alarm
        ...
        public function bookinpgress_retrieve_default_workhours( $selected_service_id, $selected_date, $minimum_time_required, $service_max_capacity, $bookingpress_show_time_as_per_service_duration ){
            ...
            global $wpdb, $tbl_bookingpress_default_workhours, $tbl_bookingpress_appointment_bookings, $tbl_bookingpress_services;
            ...
            $get_default_work_hours_data = $wpdb->get_row($wpdb->prepare("SELECT * FROM {$tbl_bookingpress_default_workhours} WHERE bookingpress_workday_key = %s AND bookingpress_is_break = 0", $current_day), ARRAY_A); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- Reason: $tbl_bookingpress_default_workhours is table name defined globally. False Positive alarm
        ...
        function bookingpress_install_default_notification_data()
        {
            ...
            'Appointment Approved' => 'Dear %customer_first_name% %customer_last_name%,<br>You have successfully scheduled appointment.<br>Thank you for choosing us,<br>%company_name%',
            'Appointment Pending'  => 'Dear %customer_first_name% %customer_last_name%,<br>The %service_name% appointment is scheduled and it\'s waiting for a confirmation.<br>Thank you for choosing us,<br>%company_name%',
            'Appointment Rejected' => 'Dear %customer_first_name% %customer_last_name%,<br>The %service_name% appointment, has been rejected.<br>Thank you for choosing us,<br>%company_name%',
            'Appointment Canceled' => 'Dear %customer_first_name% %customer_last_name%,<br>The %service_name% appointment, has been canceled.<br>Thank you for choosing us,<br>%company_name%',
            'Share Appointment URL' => 'Hi<br/>Please book your appointment with following URL: <br/>%share_appointment_url%<br/>Thanks,<br/>%company_name%',
            );
            ...
            'Share Appointment URL' => 'Hi administrator,<br>Following appointment URL is shared with customer. <br/>%share_appointment_url%<br/>Thank you,<br/>%company_name%',
            );
        ...
        {   
            ...
            'no_service_selected_for_the_booking'   => 'Please select any service to book an appointment.',
            'no_payment_method_available'  => 'Oops! There is no payment method available.',                                           
            );
        ...
        function bookingpress_install_default_customize_settings_data()
        {
            ...
            $this->bookingpress_generate_customize_css_func($bookingpress_custom_data_arr);
        }
        ...
        {   global $wpdb,$tbl_bookingpress_customize_settings;
            ...
            $bookingpress_post_id = wp_insert_post($bookingpress_bookingform_page_details);
            $bookingpress_customize_settings_db_fields = array(
            ...
            $bookingpress_post_id = wp_insert_post($bookingpress_mybooking_page_details);
            $bookingpress_customize_settings_db_fields = array(
        ...
        function bookingpress_download_payment_log_func()
        {
            ...
            if (! empty($bookingpress_view_log_selector) && ! empty($bookingpress_selected_download_duration) ) {
                ...
                $bookingpress_payment_debug_log_data = $wpdb->get_results($bookingpress_debug_payment_log_query, ARRAY_A); //phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared --Reason: $tbl_bookingpress_debug_payment_log is table name
        ...
        function bookingpress_select_date_before_load($date = '',$bookingpress_daysoff_date = array()){
			...
			if(!empty($bookingpress_daysoff_date) && is_array($bookingpress_daysoff_date)) {
				...
				/*$bookingpress_is_exist = array_search($bpa_current_date, $bookingpress_daysoff_date);
        ...
        {
            global $wpdb,$tbl_bookingpress_customers;
            $bookingpress_search_query_where = 'WHERE 1=1 AND cs.bookingpress_user_type = 2 AND cs.bookingpress_user_status = 1 ';
            ...
            if(empty($search_user_str) && !empty($customer_id )) {
                $bookingpress_search_query_where .= "AND (cs.bookingpress_customer_id = {$customer_id}) ";
            }
            ...
            $bookingpress_customer_details = $wpdb->get_results('SELECT cs.bookingpress_customer_id,cs.bookingpress_customer_id,cs.bookingpress_user_firstname,cs.bookingpress_user_lastname,cs.bookingpress_user_email FROM ' . $tbl_bookingpress_customers . ' as cs ' . $bookingpress_search_join_query . ' ' . $bookingpress_search_query_where, ARRAY_A); //phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared --Reason: $tbl_bookingpress_customers is table name
        ...
        function bookingpress_get_search_customer_list($search_user_str = '')
        {
            ...
            $bookingpress_customer_details = $wpdb->get_results('SELECT cs.bookingpress_customer_id,cs.bookingpress_user_firstname,cs.bookingpress_user_lastname,cs.bookingpress_user_email FROM ' . $tbl_bookingpress_customers . ' as cs ' . $bookingpress_search_join_query . ' ' . $bookingpress_search_query_where, ARRAY_A); //phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared --Reason: $tbl_bookingpress_customers is table name
            $bookingpress_customer_selection_details = array();
...
$bookingpress_customize_css_content .= '.bpa-front-cp-top-navbar,.bpa-front-cp-card {
...
.bpa-front-form-control--v-date-picker div.vc-highlight,
...
.bpa-front-form-control--v-date-picker div.vc-highlight.vc-highlight-base-middle {
    background: ' . $primary_alpha_color . ' !important;
}';     
...
.bpa-front-ma-table-actions-wrap .bpa-front-ma-taw__card .bpa-front-btn--icon-without-box span svg path {
    fill:'. $sub_title_color. ' !important;    
}
.bpa-ma-vac--action-btn-group .bpa-front-btn:hover span svg,
.bpa-front-ma-table-actions-wrap .bpa-front-ma-taw__card .bpa-front-btn--icon-without-box:hover span svg path {
...
.bpa-front-form-control--v-date-picker span.vc-day-content,
.bpa-front-form-control--v-date-picker div.vc-weekday,
.bpa-front-form-control--v-date-picker div.vc-title,
...
@media (max-width: 576px){                               
    ...
    .bpa-front-tabs--vertical-left .bpa-front-tab-menu .bpa-front-tab-menu--item.__bpa-is-active span {                 
        ...
        function bookingpress_replace_appointment_data($template_content,$bookingpress_appointment_data) {
            ...
            global $wpdb, $BookingPress, $bookingpress_spam_protection,$bookingpress_global_options,$tbl_bookingpress_categories,$tbl_bookingpress_services;        
            ...
            if (! empty($bookingpress_appointment_data) ) {
                ...
                $bookingpress_appointment_date       = date($default_date_format, strtotime($bookingpress_appointment_date));
                ...
                if(!empty($bookingpress_appointment_status) && $bookingpress_appointment_status != 3 && $bookingpress_appointment_status != 4)  {            
                    $bpa_unique_id = $BookingPress->get_bookingpress_customersmeta($bookingpress_customer_id, 'bpa_cancel_id');
                    if(empty($bpa_unique_id)) {
                    $bpa_unique_id          = $bookingpress_spam_protection->bookingpress_generate_captcha_code(10);                    
                    $BookingPress->update_bookingpress_customersmeta($bookingpress_customer_id, 'bpa_cancel_id', $bpa_unique_id);
                    } 
