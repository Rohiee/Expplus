        ...
        <el-row type="flex" class="bpa-mlc-head-wrap-settings bpa-gs-tabs--pb__heading">
            ...
            <el-col :xs="16" :sm="16" :md="16" :lg="16" :xl="16">
                <div class="bpa-hw-right-btn-group bpa-gs-tabs--pb__btn-group">
                    ...
                    <el-button class="bpa-btn" @click="openNeedHelper('list_daysoff_settings', 'daysoff_settings', 'Holidays')">
            ...
            <div class="bpa-gs__cb--item">
                <el-row type="flex" :gutter="32" class="bpa-gs--tabs-pb__cb-item-row">
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        ...
                        :popper-append-to-body="false" popper-class="bpa-el-select--is-with-navbar bpa-el-datepicker-widget-wrapper"></el-date-picker>
                    </el-col>
                </el-row>
                <el-row type="flex" :gutter="32" class="bpa-gs--tabs-pb__cb-item-row bpa-dcb__item-row">
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_0" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_1" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_2" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_3" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_4" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_5" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_6" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_7" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_8" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>                
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_9" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_10" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                        <div class="bpa-daysoff-calendar-col">
                            <v-calendar class="bpa-daysoff-calendar-col--item" nav-visibility="hidden" ref="calendar_11" :attributes="attributes" @dayclick="onDayClick" :locale="site_locale" :timezone="daysoff_timezone"/>
                        </div>
                    </el-col>
                </el-row>
            </div>
    ...
    <div class="bpa-dialog-heading">
        <el-row type="flex">
            <el-col :xs="12" :sm="12" :md="16" :lg="16" :xl="16">
                <h1 class="bpa-page-heading"><?php esc_html_e(' Add holiday', 'bookingpress-appointment-booking'); ?></h1>
            </el-col>
        </el-row>
    </div>
                                ...
                                <el-row>
                                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                        <el-form-item prop="daysoff_title">
                                            ...
                                            <el-input v-model="days_off_form.daysoff_title" class="bpa-form-control" placeholder="<?php esc_html_e('Enter holiday name', 'bookingpress-appointment-booking'); ?>" @blur="bookingpress_trim_value($event)"></el-input>
                                        </el-form-item>
                                    </el-col>
