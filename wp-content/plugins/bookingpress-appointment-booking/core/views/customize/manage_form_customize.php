    ...
    <el-row type="flex" class="bpa-mlc-head-wrap">
        ...
        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="bpa-hw-right-btn-group">
                ...
                <el-button class="bpa-btn" @click="openNeedHelper('list_customize', 'customize', 'Customize')">
                    ...
                    <div class="bpa-tp__body-item __bpa-is-style-type">
                        ...
                        <div class="bpa-bi__body">
                            ...
                            <el-tooltip effect="dark" content="<?php esc_html_e('Form background color', 'bookingpress-appointment-booking'); ?>" placement="top" open-delay="300">
                                <el-color-picker class="bpa-customize-tp__color-picker" v-model="selected_colorpicker_values.background_color"></el-color-picker>
                            </el-tooltip>
                            <el-tooltip effect="dark" content="<?php esc_html_e('Panel background color', 'bookingpress-appointment-booking'); ?>" placement="top" open-delay="300">
                                <el-color-picker class="bpa-customize-tp__color-picker"v-model="selected_colorpicker_values.footer_background_color"></el-color-picker>
                            </el-tooltip>
                        </div>
                    </div>                                                                                                          
                    <div class="bpa-tp__body-item __bpa-is-style-type">
                        <div class="bpa-bi__title">
                            <label class="bpa-form-label"><?php esc_html_e('Form colors:', 'bookingpress-appointment-booking'); ?></label>
                        </div>
                        <div class="bpa-bi__body">
                            <el-tooltip effect="dark" content="<?php esc_html_e('Title color', 'bookingpress-appointment-booking'); ?>" placement="top" open-delay="300">
                                <el-color-picker class="bpa-customize-tp__color-picker" v-model="selected_colorpicker_values.label_title_color"></el-color-picker>
                            </el-tooltip>
                            <el-tooltip effect="dark" content="<?php esc_html_e('Sub title color', 'bookingpress-appointment-booking'); ?>" placement="top" open-delay="300">
                                <el-color-picker class="bpa-customize-tp__color-picker" v-model="selected_colorpicker_values.sub_title_color"></el-color-picker>
                            </el-tooltip>  
                            <el-tooltip effect="dark" content="<?php esc_html_e('Content color', 'bookingpress-appointment-booking'); ?>" placement="top" open-delay="300">
                                <el-color-picker class="bpa-customize-tp__color-picker" v-model="selected_colorpicker_values.content_color"></el-color-picker>
                            </el-tooltip>    
                        </div>
                    </div>  
                    <div class="bpa-tp__body-item">    
                                        ...
                                        <el-tab-pane name="1"  v-if="booking_form_settings.hide_category_service_selection == false">
                                            <template #label>
                                                <a :class="formActiveTab == '1' ? 'bpa_center_container_tab_title' : ''" :style="[ formActiveTab == '1' ? { 'color': selected_colorpicker_values.primary_color,'font-family': selected_font_values.title_font_family} : {'color': selected_colorpicker_values.sub_title_color,'font-size': selected_font_values.content_font_size+'px','font-family': selected_font_values.title_font_family} ]">
                                                    <span class="material-icons-round" :style="[ formActiveTab == '1' ? { 'background': selected_colorpicker_values.primary_color, 'border-color': selected_colorpicker_values.primary_color  } : {'color': selected_colorpicker_values.content_color,'font-size': selected_font_values.color_font_size+'px'} ]">dns</span>
                                                            ...
                                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                                <div class="bpa-front-cat-items-wrapper">
                                                                    <div class="bpa-front-cat-items">
																		<el-tag class="bpa-front-ci-pill" :class="(bookingpress_shortcode_form.selected_category == 'all') ? '__bpa-is-active' : ''" @click="bpa_select_category('all')" :style="[bookingpress_shortcode_form.selected_category == 'all' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                        ...
                                                                        <div class="bpa-front-si__card-body">
                                                                            ...
                                                                            <div class="bpa-front-si-cb__specs">
                                                                                <div class="bpa-front-si-cb__specs-item">
                                                                                    ...
                                                                                    <strong :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}">4h</strong>
                                                                                </div>
                                                                                <div class="bpa-front-si-cb__specs-item">
                                                                    ...
                                                                    <div class="bpa-front-si-card" :style="[bookingpress_shortcode_form.selected_service == 'chronic_disease_management_2' ? { 'border-color': selected_colorpicker_values.primary_color } : '']">
                                                                        ...
                                                                        <div class="bpa-front-si__card-body">
                                                                            ...
                                                                            <div class="bpa-front-si-cb__specs">
                                                                                <div class="bpa-front-si-cb__specs-item">
                                                                                    <p :style="{ 'color': selected_colorpicker_values.content_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }">{{ booking_form_settings.service_duration_label }}</p>
                                                                                    <strong :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px' }">1h</strong>
                                                                                </div>
                                                                                <div class="bpa-front-si-cb__specs-item">
                                                                                    <p :style="{ 'color': selected_colorpicker_values.content_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }">{{ booking_form_settings.service_price_label }}</p> 
                                        ...
                                        <el-tab-pane name="2">
                                            <template #label>
                                                <a :class="formActiveTab == '2' ? 'bpa_center_container_tab_title' : ''" :style="[ formActiveTab == '2' ? { 'color': selected_colorpicker_values.primary_color,'font-family': selected_font_values.title_font_family} : {'color': selected_colorpicker_values.sub_title_color,'font-size': selected_font_values.content_font_size+'px','font-family': selected_font_values.title_font_family} ]">
                                                    <span class="material-icons-round" :style="[ formActiveTab == '2' ? { 'background': selected_colorpicker_values.primary_color, 'border-color': selected_colorpicker_values.primary_color } : {'color': selected_colorpicker_values.content_color} ]">date_range</span>
                                                            ...
                                                            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                                                                <div class="bpa-front--dt__calendar">
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}"><?php echo esc_html__('Mon','bookingpress-appointment-booking')?></td>
                                                                            <td :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}"><?php echo esc_html__('Tue','bookingpress-appointment-booking')?></td>
                                                                            <td :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}"><?php echo esc_html__('Wed','bookingpress-appointment-booking')?></td>
                                                                            <td :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}"><?php echo esc_html__('Thu','bookingpress-appointment-booking')?></td>
                                                                            <td :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}"><?php echo esc_html__('Fri','bookingpress-appointment-booking')?></td>
                                                                            <td :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}"><?php echo esc_html__('Sat','bookingpress-appointment-booking')?></td>
                                                                            <td :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}"><?php echo esc_html__('Sun','bookingpress-appointment-booking')?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bpa-front-dtc__cell-disabled" :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">30</td>
                                                                            <td class="bpa-front-dtc__cell-disabled" :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">31</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">1</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">2</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">3</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">4</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">5</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">6</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">7</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">8</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">9</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">10</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">11</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">12</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">13</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">14</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">15</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">16</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">17</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">18</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">19</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">20</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">21</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">22</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">23</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'color': selected_colorpicker_values.content_color,'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">24</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">25</td>
                                                                            <td :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px','color': selected_colorpicker_values.content_color}">26</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family,'color': selected_colorpicker_values.content_color}">27</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family,'color': selected_colorpicker_values.content_color}">28</td>
                                                                            <td :style="{'background-color':selected_colorpicker_values.primary_color,'color': 'white','font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">29</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family,'color': selected_colorpicker_values.content_color}">30</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable bpa-front-dtc__cell-disabled" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">1</td>
                                                                            <td class="bpa-front-dtc__cell-disabled" :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">2</td>
                                                                            <td class="bpa-front-dtc__cell-disabled" :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">3</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bpa-front-dtc__cell-avaliable bpa-front-dtc__cell-disabled" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">4</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable bpa-front-dtc__cell-disabled" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">5</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable bpa-front-dtc__cell-disabled" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">6</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable bpa-front-dtc__cell-disabled" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">7</td>
                                                                            <td class="bpa-front-dtc__cell-avaliable bpa-front-dtc__cell-disabled" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">8</td>
                                                                            <td class="bpa-front-dtc__cell-disabled" :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}" :style="{'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">9</td>
                                                                            <td class="bpa-front-dtc__cell-disabled" :style="{'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px'}">10</td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            </el-col>         
                                                                        ...
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            ...
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item __bpa-is-disabled">
                                                                                    ...
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('09:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('09:30'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '09:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('09:30')" :style="[bookingpress_shortcode_form.selected_time == '09:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('09:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('10:00'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '10:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('10:00')" :style="[bookingpress_shortcode_form.selected_time == '10:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('10:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('10:30'))); ?></span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '10:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('10:30')" :style="[bookingpress_shortcode_form.selected_time == '10:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        <?php echo esc_html(date($bookingpress_default_time_format,strtotime('10:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('11:00'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '11:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('11:00')" :style="[bookingpress_shortcode_form.selected_time == '11:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('11:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('11:30'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            ...
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '12:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('12:00')" :style="[bookingpress_shortcode_form.selected_time == '12:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('12:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('12:30'))); ?></span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '12:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('12:30')" :style="[bookingpress_shortcode_form.selected_time == '12:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('12:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('13:00'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '13:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('13:00')" :style="[bookingpress_shortcode_form.selected_time == '13:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('13:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('13:30'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '13:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('13:30')" :style="[bookingpress_shortcode_form.selected_time == '13:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('13:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('14:00'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            ...
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '17:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('17:00')" :style="[bookingpress_shortcode_form.selected_time == '17:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        <?php echo esc_html(date($bookingpress_default_time_format,strtotime('17:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('17:30'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '17:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('17:30')" :style="[bookingpress_shortcode_form.selected_time == '17:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('17:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('18:00'))); ?></span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '18:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('18:00')" :style="[bookingpress_shortcode_form.selected_time == '18:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('18:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('18:30'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '18:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('18:30')" :style="[bookingpress_shortcode_form.selected_time == '18:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('18:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('19:00'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            ...
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '20:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('20:00')" :style="[bookingpress_shortcode_form.selected_time == '20:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('20:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('20:30'))); ?></span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '20:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('20:30')" :style="[bookingpress_shortcode_form.selected_time == '20:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('20:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('21:00'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '21:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('21:00')" :style="[bookingpress_shortcode_form.selected_time == '21:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('21:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('21:30'))); ?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '21:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('21:30')" :style="[bookingpress_shortcode_form.selected_time == '21:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : '']">
                                                                                    <span :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                    <?php echo esc_html(date($bookingpress_default_time_format,strtotime('21:30'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('22:00'))); ?>
                                                                                </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                        ...
                                        <el-tab-pane name="3">
                                            <template #label>
                                                <a :class="formActiveTab == '3' ? 'bpa_center_container_tab_title' : ''" :style="[ formActiveTab == '3' ? { 'color': selected_colorpicker_values.primary_color,'font-family': selected_font_values.title_font_family} : {'color': selected_colorpicker_values.sub_title_color,'font-size': selected_font_values.content_font_size+'px','font-family': selected_font_values.title_font_family} ]">
                                                    <span class="material-icons-round" :style="[ formActiveTab == '3' ? { 'background': selected_colorpicker_values.primary_color, 'border-color': selected_colorpicker_values.primary_color } : {'color': selected_colorpicker_values.content_color} ]">article</span>
                                                                        ...
                                                                        <el-row :gutter="24">                                                                            
                                                                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                                                                <el-form-item ref="customer_name">
                                                                                    ...
                                                                                    <div class="bpa-form-control bpa-custom-form-control">
                                                                                        <input type="text" placeholder="<?php esc_html_e('Please enter your name', 'bookingpress-appointment-booking'); ?>" :style="{ 'color': selected_colorpicker_values.label_title_color+' !important', 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}" ></input>
                                                                                    </div>
                                                                                </el-form-item>
                                                                            </el-col>
                                                                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                                                                <el-form-item prop="customer_phone" ref="customer_phone">
                                                                                    ...
                                                                                    <vue-tel-input v-model="bookingpress_shortcode_form.cusomter_phone" class="bpa-form-control --bpa-country-dropdown" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.content_font_size +'px', 'font-family': selected_font_values.title_font_family }" @country-changed="bookingpress_customize_form_tab_phone_country_change_func($event)" v-bind="bookingpress_tel_input_props">
                                                                            ...
                                                                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                                                                <el-form-item>
                                                                                    ...
                                                                                    <div class="bpa-form-control bpa-custom-form-control">
                                                                                    <input type="email" placeholder="<?php esc_html_e('Please enter your email', 'bookingpress-appointment-booking'); ?>" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }"></input>
                                                                                    </div>
                                                                                </el-form-item>
                                                                            </el-col>
                                                                        </el-row>
                                                                        <el-row :gutter="24">
                                                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                                                <el-form-item >
                                                                                    ...
                                                                                    <div class="bpa-form-control bpa-custom-form-control">
                                                                                    <textarea class="el-textarea__inner" rows="2" placeholder="<?php esc_html_e('Please enter your note', 'bookingpress-appointment-booking'); ?>" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }"></textarea>
                                                                                    </div>
                                                                                </el-form-item>
                                                                            </el-col>
                                                                        </el-row>
                                        ...
                                        <el-tab-pane name="4">
                                            <template #label>
                                                <a :class="formActiveTab == '4' ? 'bpa_center_container_tab_title' : ''" :style="[ formActiveTab == '4' ? { 'color': selected_colorpicker_values.primary_color,'font-family': selected_font_values.title_font_family} : {'color': selected_colorpicker_values.sub_title_color,'font-size': selected_font_values.content_font_size+'px','font-family': selected_font_values.title_font_family} ]">
                                                    <span class="material-icons-round" :style="[ formActiveTab == '4' ? { 'background': selected_colorpicker_values.primary_color, 'border-color': selected_colorpicker_values.primary_color } : {'color': selected_colorpicker_values.content_color} ]">assignment_turned_in</span>
                                                                ...
                                                                <div class="bpa-front-module-container bpa-front-module--booking-summary">
                                                                    ...
                                                                    <div class="bpa-front-module--bs-summary-content">
                                                                        ...
                                                                        <div class="bpa-front-module--bs-summary-content-item">
                                                                            ...
                                                                            <div class="bpa-front-bs-sm__item-val" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                            <?php
                                                                            echo esc_html(date($bookingpress_default_date_format, current_time('timestamp'))).', '. 
                                                                            esc_html(date($bookingpress_default_time_format,strtotime('10:00'))).' - '.esc_html(date($bookingpress_default_time_format,strtotime('10:30'))) ?></div>
                                                                        </div>
                                                                        <div class="bpa-front-module--bs-summary-content-item">
                                                                            <span :style="{'color': 
                                                                    ...
                                                                    <div class="bpa-front-module--bs-amount-details">
                                ...
                                <div class="bpa-customize-booking-form-preview-container --bpa-my-bookings">
                                    <div class="bpa-cmb-step-preview" :style="{ 'background': selected_colorpicker_values.background_color }">                                
                                            ...
                                            <div class="bpa-front-cp--filter-wrapper">
                                                <div class="bpa-front-cp--fw__row">
                                                    ...
                                                    <div class="bpa-form-control bpa-custom-form-control bpa-front-cp--fw__col __bpa-is-search-icon">
                                                        ...
                                                        <input type="text" :style="{'color': selected_colorpicker_values.label_title_color,  'font-family': selected_font_values.title_font_family}" :placeholder="my_booking_field_settings.search_appointment_title" ></input>
                                                    </div>
                                        ...
                                        <div class="bpa-front-cp-ma-table__is-admin">
                                            <div class="bpa-front-ma-table__head">
                                            ...
                                            <div class="bpa-front-ma-table__body">
                                                <div class="bpa-front-mat__row" v-for="row_data in dummy_data">
                                                    <div class="bpa-mat-body__item --bpa-is-flex --bpa-is-expand-icon">
                                                        <span class="material-icons-round" :style="{'color': selected_colorpicker_values.sub_title_color}">add_circle_outline</span>
                                                    ...
                                                    <div class="bpa-mat-body__item --bpa-is-mat-body-date-info">
                                                        <div class="bpa-ma-date-time-details">
                                                            ...
                                                            <div class="bpa-ma-dt__time-val" :style="{'color': selected_colorpicker_values.sub_title_color,'font-family': selected_font_values.title_font_family }"><span class="material-icons-round" :style="{'color': selected_colorpicker_values.sub_title_color}">access_time</span>30 mins</div>
                                                        </div>
                                                    </div>
