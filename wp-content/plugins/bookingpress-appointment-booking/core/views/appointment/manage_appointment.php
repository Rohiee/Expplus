    ...
    <el-row type="flex" class="bpa-mlc-head-wrap">
        ...
        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="bpa-hw-right-btn-group">                
                ...
                <el-button class="bpa-btn" @click="openNeedHelper('list_appointments', 'appointments', 'Appointments')">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-container class="bpa-table-container">
					...
					<el-table ref="multipleTable" class="bpa-manage-appointment-items" :data="items" @selection-change="handleSelectionChange" fit="false" @row-click="bookingpress_full_row_clickable" @expand-change="bookingpress_row_expand">
						...
						<el-table-column prop="customer_name" min-width="120" label="<?php esc_html_e( 'Customer', 'bookingpress-appointment-booking' ); ?>" sortable></el-table-column>
								...
								<el-row>
									<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
										<el-form-item>
											...
											<el-select v-model="share_url_form.selected_page_id" ref="bpa_share_url_selected_page" class="bpa-form-control" placeholder="<?php esc_html_e('Select Page', 'bookingpress-appointment-booking'); ?>" filterable @change="bookingpress_generate_share_url">
												<el-option :label="pages_list.title" :value="pages_list.id" v-for="pages_list in all_share_pages">{{ pages_list.title }}</el-option>
											</el-select>
										</el-form-item>
									</el-col>
								</el-row>
