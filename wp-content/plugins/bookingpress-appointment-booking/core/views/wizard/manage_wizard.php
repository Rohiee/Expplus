...
<el-main class="bpa-fullscreen-wizard-setup">
	<div class="bpa-fws__header">
		...
		<div class="bpa-fws__help-btn">
			<el-button class="bpa-btn bpa-btn__filled-light" @click="openNeedHelper('list_quick_start_guide', 'quick_start_guide', 'Quick Start Guide')">
